...
class SimplifyExprsPass(val parseContext: ParseContext) : ProcedurePass {
  ...
  /**
   * Separates the variables in this collection. The constant variables are added to the given valuation with their values. Modified variables are returned as a list.
   */
